...
for fileName in os.listdir("inputVideos/"):
    ...
    cmd = "python3 yolo_video.py --input inputVideos/" + fileName + "--config inputVideos/" + \
          fileName[:lastDotIndex] + ".cnf --output outputVideos/" + fileName[:lastDotIndex] + ".avi --yolo yolo-coco"
